=== 0.4.0 / 2011/05/31
* JDBCHelper::TableWrapper has become Enumerable with new select, where, order methods
* WARNING: JDBCHelper::TableWrapper#select and some methods in JDBCHelper::SQL are not backward-compatible.
...
* Usability: Ruby Time object is automatically converted to java.sql.Timestamp object if the
             type of the target column is Timestamp.
